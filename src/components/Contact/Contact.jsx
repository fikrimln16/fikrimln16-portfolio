...
const Contact = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_75mztz3', 'template_1fxxr46', form.current, 'k7kIIsy0cQhIzTYNU')
       .then((result) => {
    ...
    <div id='contact' className="container">
      ...
      <div className="form">
         <div className="contact-info">
            ...
            <p className="text">
            Jika Anda merasa tertarik dengan layanan atau produk yang saya tawarkan, jangan ragu untuk menghubungi saya. Saya akan senang mendiskusikan segala hal yang berkaitan dengan proyek atau kebutuhan Anda. Terima kasih telah menghubungi saya.
            </p>
            <div className="info">
         ...
         <div className="contact-form">
            <form action="index.html" autocomplete="off" ref={form} onSubmit={sendEmail}>
               ...
               <div className="input-container">
                  <input type="text" name="user_name" className="input" placeholder="Nama" />
                  <span>Username</span>
               </div>
               <div className="input-container">
               ...
               <div className="input-container">
                  <input type="tel" name="user_phone" className="input" placeholder="Nomor Telepon"/>
                  <span>Phone</span>
               </div>
               <div className="input-container textarea">
                  <textarea name="message" className="input" placeholder="Pesan"></textarea>
                  <span>Message</span>
               </div>
